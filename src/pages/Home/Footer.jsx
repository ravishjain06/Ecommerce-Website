  ...
  return (
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-8 md:py-12">
        {/* First Row - Need Help, Company, More Info, Location */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          {/* More Info */}
          <div>
            <h3 className="text-lg font-semibold mb-4 text-yellow-400">More Info</h3>
            <ul className="space-y-2">
          ...
          {/* Location */}
          <div>
            <h3 className="text-lg font-semibold mb-4 text-yellow-400">Location</h3>
            <div className="text-gray-300 text-sm">
              <p className="mb-2">support@euphoria.in</p>
              <p className="leading-relaxed">
                Eklingpura Chouraha, Ahmedabad Main Road<br/>
                (NH 8- Near Mahadev Hotel)<br/>
        ...
        {/* Second Row - Social Icons and Download App */}
        <div className="border-t border-gray-700 pt-8 mb-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            {/* Download App */}
            <div>
              <h3 className="text-lg font-semibold mb-4 text-yellow-400">Download The App</h3>
        ...
        <div className="border-t border-gray-700 pt-8 mb-8">
          <details className="group">
            <summary className="flex justify-between items-center cursor-pointer text-lg font-semibold text-yellow-400 mb-4 list-none">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4 text-sm mt-4">
              <a href="#" className="text-gray-300 hover:text-white transition-colors">T-Shirts</a>
              <a href="#" className="text-gray-300 hover:text-white transition-colors">Jeans</a>
              <a href="#" className="text-gray-300 hover:text-white transition-colors">Dresses</a>
              <a href="#" className="text-gray-300 hover:text-white transition-colors">Jackets</a>
              <a href="#" className="text-gray-300 hover:text-white transition-colors">Shoes</a>
